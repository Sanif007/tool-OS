...
time.sleep(3)
print()
os.system("toilet -fmono12 -F red tool-OS ")
...
if op == "1" :
   ...
   os.system("cd")
   time.sleep(1.5)
   o9s.system("pkg install wget openssl-tool proot -y && hash -r && wget https://raw.githubusercontent.com/EXALAB/AnLinux-Resources/master/Scripts/Installer/Debian/debian.sh && bash debian.sh")
elif op == "12" :
